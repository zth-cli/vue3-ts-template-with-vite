...
import { isPromise, isFunction, isArray } from '@/utils'
import { toRawType } from '../utils'
import type { OptionsRow, ZthFormItemProp } from '..'
...
export const useCustomOptions = (
  ...
  if (!props.options) {
    ...
    const getValue = props.options as
      | ((props: ZthFormItemProp) => Promise<OptionsRow[]>)
      | ((props: ZthFormItemProp) => OptionsRow[])
