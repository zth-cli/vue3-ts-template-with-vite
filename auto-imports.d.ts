...
declare global {
  ...
  const checkStorange: typeof import('./src/store/appSetting')['checkStorange']
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly useConfigStroe: UnwrapRef<typeof import('./src/store/appSetting')['useConfigStroe']>
